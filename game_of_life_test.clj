...
(deftest single-tick-test
         (is (= [0]   (single-tick [1]    [[1]]             cell-state-changer-0-1)))
         (is (= [0]   (single-tick [1]    [[1 0]]           cell-state-changer-0-1)))
         (is (= [0]   (single-tick [1]    [[0]]             cell-state-changer-0-1)))
         (is (= [1]   (single-tick [1]    [[1 1]]           cell-state-changer-0-1)))
         (is (= [0]   (single-tick [0]    [[1 1]]           cell-state-changer-0-1)))
         (is (= [0]   (single-tick [0]    [[1 1 1 1]]       cell-state-changer-0-1)))
         (is (= [1]   (single-tick [0]    [[1 1 1]]         cell-state-changer-0-1)))
         (is (= [0 0] (single-tick [0 0]  [[0 1 1] [0 1 1]] cell-state-changer-0-1)))
         (is (= [0 0] (single-tick [1 1]  [[1] [1]]         cell-state-changer-0-1)))
         (is (= [1 1] (single-tick [1 1]  [[1 1] [1 1]]     cell-state-changer-0-1)))
         (is (= [1 1] (single-tick [1 0]  [[0 1 1] [1 1 1]] cell-state-changer-0-1)))
         (is (= [1 1] (single-tick [1 1]  [[1 1 1] [1 1 1]] cell-state-changer-0-1)))
         )
